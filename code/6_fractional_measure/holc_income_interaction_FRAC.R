...
poi<-places_usa_2019%>%left_join(readRDS("data/poi_seg_frac_as_rw.rds")%>%transmute(safegraph_place_id,seg_int_rw),by="safegraph_place_id")%>%
...
saveRDS(R,"results/holc_income_interaction_FRAC.rds")
