...
CBGRACE_PATH<- "./data/cbg_race_frac_2019.csv"  # FRACTIONAL composition (ACS B03002)           # GEOID,tot_pop,white,black,hispanic,asian,other (counts)
...
COMP_CACHE <- "./data/poi_seg_comp_intermediate_FRAC.rds"   # cache the (slow) streamed POI sums
...
saveRDS(out%>%select(safegraph_place_id,seg_int_unw,seg_int_rw,n_cbg,cov_rw),
  "./data/poi_seg_frac_corrected.rds")
cat("Saved ./data/poi_seg_frac_corrected.rds\n")
